...
const file_proto_user_service_proto_rawDesc = "" +
	"\n" +
	"\x18proto/user_service.proto\x12\x0eecommerce.user\"@\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\x14.ecommerce.user.UserR\x04user2Y\n" +
	"\vUserService\x12J\n" +
	"\aGetUser\x12\x1e.ecommerce.user.GetUserRequest\x1a\x1f.ecommerce.user.GetUserResponseB$Z\"github.com/your-project/proto/userb\x06proto3"
...
var file_proto_user_service_proto_goTypes = []any{
	...
	(*GetUserRequest)(nil),  // 1: ecommerce.user.GetUserRequest
	(*GetUserResponse)(nil), // 2: ecommerce.user.GetUserResponse
}
var file_proto_user_service_proto_depIdxs = []int32{
	0, // 0: ecommerce.user.GetUserResponse.user:type_name -> ecommerce.user.User
	1, // 1: ecommerce.user.UserService.GetUser:input_type -> ecommerce.user.GetUserRequest
	2, // 2: ecommerce.user.UserService.GetUser:output_type -> ecommerce.user.GetUserResponse
